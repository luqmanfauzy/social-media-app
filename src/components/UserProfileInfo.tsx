...
function UserProfileInfo({ user, posts, profileId, setShowEdit }: { user: User, posts: Post[], profileId: string, setShowEdit: React.Dispatch<React.SetStateAction<boolean>> }) {
  return (
