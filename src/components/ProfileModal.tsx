...
function ProfileModal({ setShowEdit }: ProfileModalProps) {
    ...
    return (
        <div className="fixed top-0 bottom-0 left-0 right-0 z-[110] h-screen overflow-y-scroll bg-black/50 flex items-center justify-center">
            <div className="max-w-2xl w-full sm:py-6 mx-auto px-4">
                    ...
                    <form className="space-y-4" onSubmit={handleSaveProfile}>
                        ...
                        <div className="flex flex-col items-start gap-3">
                            <label htmlFor="profile_picture" className="block text-sm font-medium text-gray-700 mb-1">
                                ...
                                <div className="group/profile relative w-fit cursor-pointer">
                        ...
                        <div className="flex justify-end space-x-3 pt-6">
                            <button onClick={() => setShowEdit(false)} type="button" className="cursor-pointer px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                                Cancel
                            </button>
                            <button type="submit" className="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-700 transition cursor-pointer">
                                Save Changes
                            </button>
                        </div>
                    </form>
